...
public class AutorController {
	...
	@Operation(summary = "Cadastra autor", description = "Cadastra um autor")
	@PostMapping
	@ResponseStatus(code = HttpStatus.CREATED)
	public AutorOutput criaAutor(@Parameter(description = "Representação de um autor")  
								@Valid @RequestBody AutorInput autor) throws URISyntaxException {
	...
	@Operation(summary = "Altera autor", description = "Altera um autor existente")
	@PutMapping("/{id}")
	public AutorOutput alteraAutor(@Parameter(description = "Id do autor", example = "1") 
									@PathVariable Long id, 
									@Parameter(description = "Representação de um autor")  
									@Valid @RequestBody AutorInput autorInput) {
	...
	@Operation(summary = "Busca autor", description = "Busca autor por ID")
	@GetMapping("/{id}")
	...
	@Operation(summary = "Lista autores", description = "Lista todos os autores cadastrados")
	@GetMapping
	...
	@Operation(summary = "Lista livros por autor", description = "Lista os livros do autor escolhido")
