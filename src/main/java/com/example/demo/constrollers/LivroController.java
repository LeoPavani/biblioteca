...
public class LivroController {
	...
	@Operation(summary = "Cadastra livro", description = "Cadastra um livro")
	@PostMapping
	@ResponseStatus(code = HttpStatus.CREATED)
	public LivroOutput criaLivro(@Parameter(description = "Representação de um livro")  
								@Valid @RequestBody LivroInput livro) {
	...
	@Operation(summary = "Altera livro", description = "Altera um livro existente")
	@PutMapping("/{id}")
	public LivroOutput alteraLivro(@Parameter(description = "Id do livro", example = "1") 
									@PathVariable Long id, 
									@Parameter(description = "Representação de um livro")  
									@Valid @RequestBody LivroInput livroInput) {
	...
	@Operation(summary = "Busca livro", description = "Busca um livro pelo ID")
	@GetMapping("/{id}")
	public LivroOutput buscaLivroPorId(@Parameter(description = "Id do livro", example = "1") 
										@PathVariable Long id) {
		LivroEntity livroEntity = livroService.buscaPeloId(id);
		return livroConvert.entityToOutput(livroEntity);
	}

	@Operation(summary = "Lista livros", description = "Lista todos os livros cadastrados")
	@GetMapping
	...
	@Operation(summary = "Exclui livro", description = "Exclui um livro")
	@DeleteMapping("/{id}")
